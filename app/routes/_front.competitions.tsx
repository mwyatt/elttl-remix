...
import {
    AnnualClosedCompetitionContent, DivisionalHandicapCompetitionContent,
...
export function meta({}) {
  return [
    ...
    { name: "description", content: "Information about the competitions held by the league annually, including the Fred Holden Cup, Annual Closed Competition, and other events." },
  ];
}
