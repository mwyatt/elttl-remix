  ...
  return (
      ...
      <div className='sm:flex gap-16'>
        ...
        <div className='flex-1'>
          ...
          <p>Always open to ideas and criticism of the website so please provide any feedback to <Link className={linkStyles.join(' ')} to={`mailto:${DeveloperEmail}`}>{DeveloperEmail}</Link>.</p>
        </div>
      </div>
</>
  )
